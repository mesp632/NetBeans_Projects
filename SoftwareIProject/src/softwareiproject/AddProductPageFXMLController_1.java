 ...
 * @author Michelle
 */
public class AddProductPageFXMLController_1 implements Initializable {
...
//part col value collection end
    ...
    private void addAssociatedPart(ActionEvent event) {
        ...
        for(int i=0; i < maxIndex; i++){
         ...
         //associatedPartsTable.getColumns().clear();
         associatedPartsTable.setItems(tempAssociatedPartList);
    ...
    private void handleSaveButtonAction(ActionEvent event) {
        ...
        if("".equals(getproductIDField.getText())){
            ...
            testRadio.setText("Minimum must be less than Maximum");
        }
        else{
